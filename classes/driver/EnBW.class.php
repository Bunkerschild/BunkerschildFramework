...
final class EnBW
{
    const ENBW_METER_START_TIMESTAMP = "2014-03-01 00:00:00";

    const ENBW_PRICE_EUR_KWH_HT = 0.275;
    const ENBW_PRICE_EUR_KWH_NT = 0.255; 
    
    use \BunkerschildFramework\traits\driver\EnBW;
}
